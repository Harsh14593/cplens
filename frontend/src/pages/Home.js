    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        {user ? (
          ...
          <button className={styles.googleBtn} disabled={signingIn} onClick={async () => { if (signingIn) return; setSigningIn(true); try { await login(); } catch {} finally { setSigningIn(false); } }}>
